...
function visiVardai() {
  $gydytojuVardaiSQL = "SELECT name * FROM doctors ";
  $rezulataiVardaiSQL = mysqli_query( getPrisijungimas() , $gydytojuVardaiSQL);
  $rezultataiVardaiMasyvas = ($rezulataiVardaiSQL);
  return $rezultataiVardaiMasyvas;
}

$gydytojuVardaiPoFunkcijos = visiVardai();
