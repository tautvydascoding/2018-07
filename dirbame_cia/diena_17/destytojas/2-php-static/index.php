...
<html>
    ...
    <body>
        <div class="container   ">
            ...
            <?php
                 function test () {
                     static $a = 100;   // !!!! si eilute suveiks tik viena karta gyvenime
                     echo $a . "<br />";
                     $a -= 12; //$a = $a - 12;
                 }
                 test();
                 ...
                 // rekursija - tai yra f-ja, kuri iskviecia pati save
                // UZDUOTIS
                // iskviesti f-ja viena karta
                // bet si f-ja turi suveikti `10 kartu
                // (atspausdinti kelinta karta ji suveike)
                function test2(){
                    static $i = 1;
                    $i++;
                    if ($i < 11) {
                        test2();
                        echo "Paliedimo nr: $i     <br />";
                    }
                }
                test2();
             ?>
