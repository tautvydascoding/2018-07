    ...
    <body>
        <div class="container   ">
            ...
            <form action="send-email.php" method="post">
                <input type="text" name="antraste" value="" placeholder="antraste"><br>
                <input type="email" name="elpastas" value="" placeholder="email"><br>
                <input type="text" name="vardas" value="" placeholder="vardas"><br>
                <textarea name="klausimas" rows="4" cols="40" placeholder="Klausimas"></textarea><br>
