...
<?php
 ...
 ?>
        <form  action="send-email.php" method="post">
            ...
            <input type="text" name="antrate" placeholder="Sritis" value="">
            <textarea name="klausimas" rows="8" cols="80" placeholder="Jusu klausimas"></textarea>

            <input type="email" name="elpastas" placeholder="a@a.lt" value="">

            <input type="submit" name="button"   value="Klausti">
        </form>
