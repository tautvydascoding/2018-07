...
<html>
    ...
    <body>
        <div class="container   ">
            ...
            <form action="sentmailer.php" method="POST">

                <label for="name">Jusu vardas:</label>
                <input type="text" name="name"> 

                <label for="lastName"> Jusu pavarde:</label>
                <input type="text" name="lname"> <br>

                <label for="phone">Jusu telefonas:</label>
                ...
                <textarea name="question" id="" cols="30" rows="10" placeholder="Jusu klausimas..."></textarea> <br>
                <br>
