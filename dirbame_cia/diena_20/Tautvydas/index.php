...
<html>
    ...
    <body>
        <div class="container">
          <div class="row">
            <div class="col-12 aukstis-100 fonas-rud mb-3">
              Top header
            </div>
          </div>
          <div class="row">
            <div class="col-12 aukstis-20 fonas-rud mb-3">
              Top menu
            </div>
          </div>
          <div class="row">
            <div class="col-7 mr-3">
              <div class="row">
                <div class="col-12 aukstis-300 fonas-rud mb-3">
                    Post 1
                </div>
              </div>
              <div class="row">
            ...
            <div class="col">
              <div class="row">
                <div class="col-12 aukstis-200 fonas-rud mb-3">
                  Newsletter
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col aukstis-100 fonas-rud mb-3">
                  ???
                </div>
                <div class="ml-3">
              ...
              <div class="row">
                <div class="col-12 fonas-rud aukstis-50 mb-3">
                  ??
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-12 aukstis-20 fonas-rud">
              footer
            </div>
          </div>
